...
export const metadata: Metadata = {
  title: "大田黑公園｜荻窪的免費日本庭園・錦鯉與紅葉✅實訪",
  description:
    "荻窪站走10分、免費入園的迴遊式日本庭園「大田黑公園」。淺淺的小溪就在腳邊，錦鯉近到看得見鱗片。附開園時間・休園日・交通與紅葉時期。",
  alternates: {
    canonical: PAGE_URL,
  ...
  openGraph: {
    title: "大田黑公園｜荻窪的免費日本庭園・錦鯉與紅葉",
    description: "荻窪站走10分、免費入園的迴遊式日本庭園。錦鯉游在腳邊的淺溪裡，秋天還有百年銀杏與紅葉🍁",
    url: PAGE_URL,
    type: "article",
    locale: "zh_TW",
  ...
  twitter: {
    ...
    title: "大田黑公園｜荻窪的免費日本庭園・錦鯉與紅葉",
    description: "荻窪站走10分・免費入園。錦鯉游在腳邊的淺溪，秋天有百年銀杏並木🍁",
    images: [OG_IMAGE],
  },
};
...
const articleJsonLd = {
  ...
  "@type": "BlogPosting",
  headline: "大田黑公園（大田黒公園）｜荻窪的免費日本庭園・錦鯉與紅葉【實際造訪】",
  description:
    "東京杉並區荻窪的迴遊式日本庭園「大田黑公園」。免費入園，池與淺溪裡養著錦鯉，秋天有樹齡百年的銀杏並木與紅葉。附開園時間・休園日・交通。",
  url: PAGE_URL,
...
const faqItems = [
  ...
  {
    q: "真的看得到錦鯉嗎？",
    a: "看得到。水從茶室・休息所後方流出來，穿過樹林注入南側的池子，錦鯉就在這條淺淺的小溪與池裡游。溪水很淺、距離很近，連鱗片和嘴巴開合都看得清楚。運氣好的話還會遇到野鴨或白鷺。",
  },
  {
    q: "可以餵魚嗎？",
    a: "園內沒有販賣部，也沒有賣魚飼料。日本的庭園多半禁止自行餵食，現場的告示牌怎麼寫就怎麼遵守最保險。不餵也完全不影響——錦鯉本來就會靠過來。",
  },
  {
    q: "什麼季節去最漂亮？",
    ...
    <div className="min-h-screen bg-amber-50 wagara font-sans">
      ...
      <article className="max-w-2xl xl:max-w-[920px] mx-auto px-4 py-6">
        ...
        <h1 className="text-2xl font-black text-stone-800 leading-tight mb-2">
          大田黑公園（大田黒公園）<br />荻窪的免費日本庭園・錦鯉游在腳邊🐟
        </h1>
        ...
        <section className="bg-white rounded-2xl border border-yellow-100 shadow-sm p-5 mb-8">
          ...
          <p className="text-sm text-stone-600 leading-relaxed">
            這裡原本是日本草創期的音樂評論家<strong>大田黑元雄</strong>的宅邸，1981年由杉並區整建成<strong>迴遊式日本庭園</strong>對外開放。最有意思的是那條穿過樹林的<strong>淺溪</strong>——<strong>錦鯉就游在你腳邊</strong>，水淺到連鱗片都看得一清二楚🐟
          </p>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-stone-100 shadow-sm p-5 mb-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <span className="text-green-500 font-black text-sm shrink-0">▸</span>
              <div>
                <p className="text-sm font-bold text-stone-700">錦鯉的距離近到誇張</p>
                <p className="text-xs text-stone-500 leading-relaxed">池子之外還有一條淺溪，鯉魚就在石頭之間游，小朋友也看得很開心🐟</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-green-500 font-black text-sm shrink-0">▸</span>
        ...
        {/* H2 */}
        <h2 className="text-lg font-black text-stone-800 mb-4 piyo-h piyo-jump">東京看錦鯉的公園・大田黑公園</h2>
        ...
        <section className="bg-white rounded-3xl border border-stone-100 shadow-sm overflow-hidden mb-8 card-split">
          ...
          <div className="p-5">
            ...
            <p className="text-sm text-stone-600 leading-relaxed mb-3">
              佔地約<strong>8,972㎡</strong>的迴遊式日本庭園，1981年開園🌳 水從茶室・休息所後方流出，緩緩穿過樹林，注入園區南側的池子。<strong>錦鯉就養在這條水路上</strong>——池子裡固然看得到，但真正好看的是那段<strong>淺到只到腳踝的小溪</strong>：橘紅色與黑色的鯉魚在石頭之間擠來擠去，水面波光一閃一閃的，站著看十分鐘也不膩。除了鯉魚，<strong>有時還會看到野鴨與白鷺</strong>。
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {["🆓 免費入園", "🐟 錦鯉的淺溪", "🍁 百年銀杏並木", "🎹 1900年史坦威", "🚶 荻窪站走10分"].map((t) => (
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-xl px-4 py-3 mb-3">
              ...
              <ul className="text-xs text-stone-600 space-y-1.5">
                ...
                <li><strong>池與淺溪</strong>：錦鯉游在腳邊，偶爾有野鴨與白鷺</li>
            ...
            <div className="bg-stone-50 border border-stone-100 rounded-xl px-4 py-3 mb-3 space-y-1">
              ...
              <p className="text-xs text-stone-600">🚗 沒有停車場・園內沒有販賣部（飲料請自備）</p>
        ...
        {/* 餵魚について */}
        <section className="bg-white rounded-2xl border border-yellow-100 shadow-sm p-5 mb-8">
          <h2 className="text-base font-black text-stone-800 mb-3 piyo-h piyo-hatena">關於「餵錦鯉」這件事</h2>
          <p className="text-sm text-stone-600 leading-relaxed mb-2">
            在日本，會賣魚飼料給遊客餵的庭園其實不多，<strong>大田黑公園園內沒有販賣部，也沒有賣飼料</strong>。日本的庭園多半不希望遊客自行帶食物餵魚（會影響水質與魚的健康），所以<strong>以現場的告示牌為準</strong>最保險。
          </p>
          <p className="text-sm text-stone-600 leading-relaxed">
            不過不用擔心會無聊——這裡的<strong>水路很淺、護欄也低</strong>，就算不餵，錦鯉也會自己游過來，近到可以看清楚每一片鱗片。想拍鯉魚特寫的話，這種淺溪反而比深池好拍得多📸
          </p>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-yellow-100 shadow-sm p-5 mb-8">
          ...
          <ul className="space-y-2 text-sm text-stone-600">
            ...
            <li>✅ 園內<strong>沒有販賣部</strong>，飲料在荻窪站買好再走過去</li>
        ...
        <div className="bg-white rounded-3xl border border-yellow-200 shadow-sm p-6 mb-10">
          <p className="text-sm text-stone-600 leading-relaxed mb-4">
            ...
            蹲在淺溪邊看錦鯉游來游去，那十分鐘大概是整趟東京行裡最放鬆的一段。
          </p>
          <div className="flex items-start gap-3 bg-yellow-50 border border-yellow-200 rounded-2xl p-4">
            <div className="text-3xl shrink-0">🐥</div>
            <div>
              <p className="text-sm font-semibold text-stone-700 mb-0.5">ぽやぴよ的話</p>
              <p className="text-sm text-stone-600">「水淺到連鯉魚的鱗片都數得出來，不用餵也看得超開心🐟」</p>
            </div>
          </div>
        </div>
