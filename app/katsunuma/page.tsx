...
const faqs = [
  ...
  { q: "勝沼・山梨可以買什麼伴手禮（手信）？", a: "回程順路去「桔梗信玄餅工場」最有效率。信玄餅是山梨的代表伴手禮，常溫保存，很適合帶回台灣・香港送人；工場可以參觀，裡面的咖啡廳（咖啡店）還吃得到信玄餅霜淇淋。" },
  { q: "下雨天去也可以嗎？", a: "酒莊行程本來就是室內為主，影響不大。シャトー・メルシャン的品酒空間旁有爬滿葡萄藤的露台庭園，下雨天反而別有一番療癒感。只有採桃、採葡萄這類戶外體驗會受天氣影響，出發前先跟果園確認。" },
];
