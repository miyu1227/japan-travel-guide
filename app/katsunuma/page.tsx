...
const KLOOK_KOUSHIEN =
  "https://affiliate.klook.com/redirect?aid=124502&aff_adid=1339963&k_site=https%3A%2F%2Fwww.klook.com%2Fja%2Fhotels%2Fdetail%2F491613-meitei-no-yado-hotel-koushien%2F%3Fcheck_in%3D2026-08-16%26check_out%3D2026-08-17%26room_num%3D1%26adult_num%3D1%26child_num%3D0";
          ...
          <div className="p-5">
            ...
            >
              ...
              <div className="relative flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] text-stone-500 bg-white/60 backdrop-blur px-2 py-0.5 rounded-full">石和溫泉旅館・空房查詢</span>
              </div>
              <div className="relative flex items-center gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-base font-black text-stone-800 leading-tight mb-1">銘庭の宿 ホテル甲子園・空房查詢</h3>
                  <p className="text-xs text-stone-700 leading-relaxed">石和溫泉的老字號溫泉旅館。日式庭園＋露天風呂＋會席料理，出發前先看看空房與價格更方便安排一泊二日行程♨️</p>
                </div>
              </div>
