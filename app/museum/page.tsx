...
const faqs = [
  ...
  { q: "下雨天也可以去嗎？（室內行程）", a: "很適合當雨天的備案。國立新美術館整天都待在室內也不無聊；根津美術館的展間是室內，只有日本庭園要走到戶外，雨天以展間為主就好。兩間都直接連到地鐵站附近，移動時淋雨的時間很短。" },
  { q: "哪裡最好拍照打卡？", a: "國立新美術館的玻璃曲面建築本身就是最好拍的一張，就算沒有看展也值得專程去；根津美術館則是那座很漂亮的日本庭園。平日上午人最少，可以安靜地拍。" },
];
