...
const faqs = [
  ...
  { q: "適合帶小朋友一起去嗎？（親子）", a: "很適合。園內有兒童森林、大草坪「みんなの原っぱ」與自行車道，自帶野餐墊和便當在草坪上野餐是最舒服的玩法。面積165公頃（東京迪士尼樂園的3倍以上），走不動的話租自行車環園最省力。" },
  { q: "冬天的燈光秀可以看夜景嗎？", a: "可以。冬季的「Winter Vista Illumination」期間會延長開園時間，是這座公園一年裡少數能待到天黑的時段。其他季節基本上是白天的公園，想賞夜景就鎖定這段期間。" },
];
