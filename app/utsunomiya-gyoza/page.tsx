...
const faqs = [
  ...
  { q: "餃子可以外帶當伴手禮（手信）嗎？", a: "正嗣的外帶包裝做得很完善，一份6個¥270，帶回飯店（酒店）吃也OK。正嗣店內座位不多，本來就有很多人直接外帶。" },
  { q: "宇都宮餃子一日遊怎麼排？", a: "東京搭新幹線約50分，中午前抵達最順。みんみん在宇都宮駅西口徒歩約10分（11:00〜20:00・週三公休），正嗣徒歩約15分（11:30〜20:00・週二公休）。想一天吃兩家對決的話，週二和週三都要避開。假日中午常排隊1小時以上，開店前到最保險。" },
];
