...
const faqs = [
  ...
  { q: "預算大概要抓多少？", a: "午餐約¥3,000起、晚餐約¥8,000起，套餐¥15,000起。想用比較輕的預算吃到同一間店的味道，午餐時段最划算。" },
  { q: "從銀座站走幾分鐘？幾點營業？", a: "東京Metro銀座線・丸之內線・日比谷線「銀座」駅徒歩約2分，店在銀座Nouvo的11樓。營業11:00〜22:00（會依時期變動），晚餐時段強烈建議先訂位。" },
];
