...
export const HUBS: Hub[] = [
  {
    ...
    intro: [
      ...
      "這一頁把我們實際走過的8間東京咖啡廳，<strong>依區域整理成散步路線</strong>，也是最常被問到的東京咖啡廳推介清單。每篇都附交通方式、營業時間、必點品項與價位，可以直接照著排半天行程。",
    ],
    guide: [
      {
        q: "只有半天，該選哪一區？",
  ...
  },
  {
    ...
    description:
      "東京必吃・必食美食總覽：排隊拉麵6選、高級燒肉與內臟燒肉、新大久保韓國街、銀座希臘料理、外帶蛋糕與伴手禮。每篇都實際吃過，附交通、價位與訂位重點。",
    h1: "東京美食推薦總整理",
    crumb: "東京美食推薦",
    emoji: "🍜",
    badge: "🍜 美食總覽",
  ...
  },
  {
    ...
    description:
      "從東京出發1〜2小時的近郊小旅行：箱根浪漫特快一日遊、橫濱野毛續攤掃街、湘南海灘野餐、宇都宮餃子、山梨勝沼酒莊與溫泉。附交通方式、所需時間與當天來回的可行性判斷。",
    h1: "東京近郊一日遊推薦",
    crumb: "東京近郊一日遊",
    emoji: "🚃",
    badge: "🚃 近郊小旅行",
  ...
  },
  {
    ...
    guide: [
      ...
      {
        q: "咖啡廳幾點去比較不用排隊？",
        a: "四間都是人氣店，平日上午最鬆。熊熊主題的麵包吃到飽甚至開店前就有人排。",
      },
    ],
    sections: [
      {
