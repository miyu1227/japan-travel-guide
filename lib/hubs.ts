...
export const HUBS: Hub[] = [
  ...
  },
  {
    ...
    guide: [
      ...
      {
        q: "門票要先在網路上買嗎？",
        a: "晴空塔與舞浜周邊的票券建議先訂，假日與傍晚的人氣時段現場排隊會花掉不少時間。公園類多半現場買票就好。",
      },
      {
        q: "香港朋友問的「東京景點推介」，和台灣說的「東京景點推薦」一樣嗎？",
  ...
  {
    slug: "kobe",
    title: "神戶一日遊推薦｜神戶牛、有馬溫泉、北野異人館推介",
    description:
  ...
  {
    slug: "osaka",
    title: "大阪必食推介｜梅田在地美食、沾麵、飯店自助餐",
    description:
      "大阪必食、大阪美食推薦總覽：梅田・福島的在地鐵板燒與居酒屋、肥後橋的濃厚魚介沾麵、康萊德40樓的景觀自助餐。不用排一小時也吃得到，附交通、預算帶與訂位重點。",
    h1: "大阪必食推介・美食推薦",
    crumb: "大阪必食",
    emoji: "🍻",
    badge: "🍻 大阪總覽",
  ...
  },
  {
    ...
    guide: [
      ...
      {
        q: "第二次來關西，去哪裡？",
        a: "京都伊根的舟屋村、和歌山白浜的海岸與動物樂園，都是離開市區才看得到的風景。",
      },
      {
        q: "台灣・香港出發，關西怎麼進出最順？",
