...
export const ARTICLES: Article[] = [
  ...
  },
  {
    slug: "osaka-gourmet",
    category: "ramen",
    name: "大阪鐵板燒・居酒屋推薦｜梅田・福島在地人氣2店🍻",
    shortLabel: "大阪鐵板燒・居酒屋",
    desc: "鉄板屋な。（套餐¥5,000〜）＆酒場ビリー（串燒¥150〜），梅田晚餐這樣排",
    tag: "大阪",
    emoji: "🍻",
  ...
  },
  {
    slug: "kansai-ramen",
    category: "ramen",
    name: "大阪沾麵推薦｜肥後橋つじ田的濃厚豚骨魚介沾麵🍜",
    shortLabel: "大阪沾麵推薦",
    desc: "濃厚沾麵¥1,050・酢橘與黑七味三段吃法・肥後橋站1分。附菜單價格、營業時間、不用排的時段",
    tag: "大阪",
    emoji: "🍜",
  ...
  },
  {
    slug: "kamikochi",
    category: "spot",
    name: "上高地攻略2026｜交通、開山期間、散策路線與奧飛騨溫泉🏔️",
    shortLabel: "上高地攻略",
    desc: "開山4/17〜11/15・高山出發巴士90分¥3,100・河童橋散策路線，加上新穂高纜車與奧飛騨溫泉",
    tag: "其他",
    emoji: "🏔️",
