...
export const ARTICLES: Article[] = [
  ...
  {
    slug: "kansai-5day-itinerary",
    category: "spot",
    name: "關西5天4夜行程｜大阪・神戶的完整安排🏯",
    shortLabel: "關西5天4夜行程",
    desc: "大阪梅田到神戶三宮只要30分，不用換飯店。美食・溫泉・夜景的5天4夜範例",
    tag: "關西",
    emoji: "🏯",
  ...
  {
    slug: "tokyo-5day-itinerary",
    category: "spot",
    name: "東京5天4夜行程推薦｜第一次自由行的完整安排🗺️",
    shortLabel: "東京5天4夜行程",
    desc: "一天一區域、一天最多3個點。定番景點2天＋咖啡巡禮1天＋近郊1天的完整範例",
    tag: "東京",
    emoji: "🗺️",
